...
class TestGateMap(QiskitVisualizationTestCase):
    ...
    def test_plot_gate_map(self, backend):
        ...
        result_img = _write_plot_to_image(fig)
        self.assertImagesAreEqual(result_img, img_ref, 0.2)
        plt.close(fig)
    ...
    def test_plot_circuit_layout(self, backend):
        ...
        result_img = _write_plot_to_image(fig)
        self.assertImagesAreEqual(result_img, img_ref, 0.1)
        plt.close(fig)
